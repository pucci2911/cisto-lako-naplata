  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-card rounded-xl p-6 shadow-sm shadow-black/5 space-y-4">
        ...
        <div><Label className="text-sm">Podrazumevani broj dana za gotovost</Label><div><Label className="text-sm">Podrazumevani broj dana za gotovost</Label><Input type="number" value={settings.defaultTurnaroundDays} onChange={e => update('defaultTurnaroundDays', Number(e.target.value))} className="h-11 w-32" />{fieldError('defaultTurnaroundDays')}</div> onChange={e => update('defaultTurnaroundDays', Number(e.target.value))} className="h-11 w-32" />{fieldError('defaultTurnaroundDays')}</div>
